        ...
        <div className=' bg-white shadow-md flex flex-col gap-6 w-2/3 lg:w-1/3 p-6 border rounded-md'>
            ...
            {!isOtpSent&&<div className='w-full flex flex-col gap-6'>
                <div className="relative w-full min-w-[200px] h-10">
                    ...
                    {hospitalError&&<div className=' text-xs text-red-500 mb-2'>*Please enter email address</div>}
                </div>
                <div className="relative w-full min-w-[200px] h-10">
                ...
                <div className="flex items-center mb-4">
                    ...
                    <label htmlFor="default-checkbox" className="ms-2 text-sm font-medium text-gray-500">I agree term and conditions of HealthKard</label>
                </div>
            </div>}
            {isOtpSent && <div className='flex gap-4 flex-col'>
                <div className=''>Enter OTP</div>
                <OTPInput value={OTP} onChange={setOTP} autoFocus OTPLength={4} otpType="number" disabled={false}   inputClassName='border-2 border-black rounded-md ' className='w-full flex justify-between '/>
                <div className='text-sm px-2'>Enter OTP received to {email}</div>
            </div>}
