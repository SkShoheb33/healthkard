  ...
  return (
    <div className='w-full h-10 flex items-center justify-between'>
        ...
        <div className='flex items-center gap-2 w-1/3 justify-center'>
            <Link to='deny' className='w-1/3 text-center  red text-white px-3 py-1 hover:cursor-pointer rounded'>Delete</Link>
            <Link to='edit' className='w-1/3 text-center  blue text-white px-3 py-1 hover:cursor-pointer rounded'>Edit</Link>
        </div>
    </div>
  )
}
