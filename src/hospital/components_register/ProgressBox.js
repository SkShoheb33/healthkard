...
function ProgressBox() {
  ...
  return (
    <div className='mx-auto w-full md:w-2/3 flex flex-col gap-4  shadow-md rounded-md py-4 pb-6 h-fit'>
        <div className='text-2xl font-semibold border-b-2 p-4'>Create your Hospital page</div>
        <NavLink onClick={()=>a()} to='hospitalDetails' className='flex  p-1 items-center justify-between hover:cursor-pointer '>
            <div id='a'  className='shadow-lg rounded-full border p-3 text-xs w-[20px] h-[20px] flex justify-center items-center mx-auto  '>1</div>
        ...
        <NavLink onClick={()=>b()} to='doctorDetails' className='flex items-center justify-between hover:cursor-pointer'>
            <div id='b'  className='shadow-lg rounded-full border p-3 text-xs w-[20px] h-[20px] flex justify-center items-center mx-auto'>2</div>
            <div className='flex flex-col w-4/5 pr-3'>
        ...
        <NavLink onClick={()=>c()} to='mediaDetails' className='flex items-center justify-between hover:cursor-pointer'>
            <div id='c'  className='shadow-lg rounded-full border p-3 text-xs w-[20px] h-[20px] flex justify-center items-center mx-auto'>3</div>
            <div className='flex flex-col w-4/5 pr-3'>
