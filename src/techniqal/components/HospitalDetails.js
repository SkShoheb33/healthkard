...
function HospitalDetails() {
    ...
    const data = {
        ...
        "from": "08:00",
        "gstNumber": "GST1291031",
        "hospitalGSTFile": "https://firebasestorage.googleapis.com/v0/b/healthkard.appspot.com/o/Hospital%2FHH242811026%2FhospitalGSTFile%2FAccenture%20-%20VSP24!%20Hiring%20timelines%20and%20key%20instructions%20-%20Mail.pdf?alt=media&token=4677c743-9331-4d5e-b544-0c5329dcd67a",
        "hospitalLegalName": "Shoheb Hospital",
        "hospitalLicense": "https://firebasestorage.googleapis.com/v0/b/healthkard.appspot.com/o/Hospital%2FHH242811026%2FhospitalLicense%2FAccenture%20-%20VSP24!%20Hiring%20timelines%20and%20key%20instructions%20-%20Mail.pdf?alt=media&token=e24cde19-2c02-4ed6-92d3-2a94b671caa5",
        "hospitalNumber": "919347235528",
        "hospitalOwnerContactNumber": "919347235528",
        "hospitalOwnerEmail": "shaikshoheb9k@gmail.com",
        "hospitalOwnerFullName": "Shaik Shoheb",
        "hospitalTradeName": "Same Name",
        "licenseNumber": "Lis9091081",
        "address": {
          "lat": "17.5013888",
          "lng": "78.4007168",
          "city": "Guntur",
          "code": "522003",
          "country": "India",
          "landmark": "Near Suffa Masjid",
          "state": "Andhara Pradesh",
          "street": "Anandapet 3rd line"
        },
        "servicesOffered": "Ear Nose",
        "to": "20:00"
      };
  return (
    <div className='flex flex-col h-[75vh] rounded-md overflow-scroll p-2 border pb-6 border-gray-100'>
        ...
        <div className='w-full flex light-green p-3 rounded-md hover:font-bold hover:cursor-pointer'>
            ...
            <div className='flex gap-3'>
                {Object.keys(data.daysAvailabilty).map((day,index)=>{
                    return(
                        <div className={`rounded-full w-[24px] h-[24px] flex justify-center items-center ${data.daysAvailabilty[day]?'green text-white':'bg-white'}`}>{day}</div>
                    )
                })}
            </div>
        </div>
