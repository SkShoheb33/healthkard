...
function ProgressBox() {
  ...
  return (
    <div id='progressbox' className='w-full md:w-2/3 flex flex-col gap-4 shadow-md rounded-md py-4 pb-6 h-fit'>
      ...
      <NavLink to='/hospitalRegister/doctorDetails' className='flex items-center justify-between hover:cursor-pointer' activeclassname='active-step'>
        <div className={`shadow-lg rounded-full border p-2 text-sm font-semibold w-[30px] h-[30px] flex justify-center items-center mx-auto ${activeStep === 2 ? 'green text-white' : ''}`}>2</div>
        <div className='flex flex-col w-4/5 pr-3'>
          <div className='text-xl'>Doctor Details</div>
          <div className='text-xs'>Description about Hospital, Doctors, posters etc..</div>
        </div>
      </NavLink>
      <NavLink to='/hospitalRegister/mediaDetails' className='flex items-center justify-between hover:cursor-pointer' activeclassname='active-step'>
        <div className={`shadow-lg rounded-full border p-2 text-sm font-semibold w-[30px] h-[30px] flex justify-center items-center mx-auto ${activeStep === 3 ? 'green text-white' : ''}`}>3</div>
        <div className='flex flex-col w-4/5 pr-3'>
