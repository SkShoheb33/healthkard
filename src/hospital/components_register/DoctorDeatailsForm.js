...
function DoctorDeatailsForm(props) {
    const [doctorDetails,setDoctorDetails] = useState(props.doctor || {
      ...
      useEffect(() => {
        ...
        storedDoctorList[props.index] = doctorDetails;
        localStorage.setItem('doctorList', JSON.stringify(storedDoctorList));
      }, [doctorDetails, props.index]);
    ...
    return(
        <div className='mt-6 mb-6'>
          <div className='w-full p-3  mt-10 flex flex-col gap-8'>
            ...
            <div className="w-full">
              <div className="relative w-full min-w-[200px] h-10">
                <input value={props.doctor.email} onChange={(e)=>setDoctorDetails({...doctorDetails,email:e.target.value})} className="border- peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200  focus:border-2 border-t-transparent focus:border-t-transparent text-md p-5 rounded-[5px]  focus:border-gray-900" placeholder=" " />
            ...
            <div className="w-full">
              <div className="relative w-full min-w-[200px] h-10">
                <input value={props.doctor.qualification} onChange={(e)=>setDoctorDetails({...doctorDetails,qualification:e.target.value})} className="border- peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200  focus:border-2 border-t-transparent focus:border-t-transparent text-md p-5 rounded-[5px]  focus:border-gray-900" placeholder=" " />
            ...
            <div className="w-full">
              <div className="relative w-full min-w-[200px] h-10">
                <input value={props.doctor.lisenceNumber} onChange={(e)=>setDoctorDetails({...doctorDetails,lisenceNumber:e.target.value})} className="border- peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200  focus:border-2 border-t-transparent focus:border-t-transparent text-md p-5 rounded-[5px]  focus:border-gray-900" placeholder=" " />
            ...
            <div className='w-full flex items-center gap-2 md:gap-2'>
                <div className='p-2 rounded-md'>+91</div>
                <div className="relative w-1/2 min-w-[200px] h-10">
                  <input value={props.doctor.number} onChange={(e)=>setDoctorDetails({...doctorDetails,number:e.target.value})} className="border- peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200  focus:border-2 border-t-transparent focus:border-t-transparent text-md p-5 rounded-[5px]  focus:border-gray-900" placeholder=" " />
